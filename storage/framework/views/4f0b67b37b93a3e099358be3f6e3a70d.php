...
<body>
    <div class="login-container">
        ...
        <div class="signup-link">
            ¿No tienes una cuenta? <a href="<?php echo e(route('register')); ?>" class="link-primary text-decoration-none">Crear Cuenta</a>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\login_form-main\resources\views/auth/login.blade.php ENDPATH**/ ?>