...
<body>
    <div class="container">
        ...
        <div class="login-link">
            Tienes una cuenta? <a href="<?php echo e(route('login')); ?>" class="link-primary text-decoration-none">Iniciar sesion</a>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\login_form-main\resources\views/auth/registration.blade.php ENDPATH**/ ?>